...
public final class ToolFactory {
    ...
    public static Tool makeWateringCan(){ return new Tool(0, ToolConfig.getToolSpec("Watering can"),new WateringCanAction(),ToolQuality.BASIC);}
    public static Tool makeFishingPole(){ return new Tool(0, ToolConfig.getToolSpec("Fishing pole"),new FishingPoleAction(),FishingQuality.TRAINING);}
    public static Tool makeScythe(){      return new Tool(0, ToolConfig.getToolSpec("Scythe"),     new ScytheAction(),     ToolQuality.BASIC);}
    public static Tool makeMilkPail(){    return new Tool(0, ToolConfig.getToolSpec("Milk pail"),   new MilkPailAction(),   ToolQuality.BASIC);}
