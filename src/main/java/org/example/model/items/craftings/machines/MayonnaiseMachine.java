...
public class MayonnaiseMachine extends Machine{
    public MayonnaiseMachine(String name, int basePrice, AbilityType abilitySource, int levelSource, boolean canCraft, List<MachineRecipe> recipes) {
